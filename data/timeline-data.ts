...
export const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    date: "המשך הסיפור",
    content:
      "אנחנו כאן בגלל אברהם העברי הראשון, בגלל אמהות ואבות האומה, בגלל כלב ודוד המלך, בגלל אלפי השנים של קשר עמוק לארץ הזאת.",
    image: "/images/timeline/timeline-14-why-are-we-here.png",
  },
  {
    id: 15,
    title: "סיכום",
